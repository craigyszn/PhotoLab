...
public class PortfolioController {
    ...
    @PostMapping
    public PortfolioEntity create(@RequestBody PortfolioEntity p) { return service.create(p); }

    @PutMapping("/{id}")
    public ResponseEntity<PortfolioEntity> update(@PathVariable Long id, @RequestBody PortfolioEntity p) {
